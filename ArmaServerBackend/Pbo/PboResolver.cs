...
namespace ArmaServerBackend
{
    ...
    /// </summary>
    public abstract class PboResolver
    {
        /// <summary>
    ...
    /// </summary>
    public class PboDataResolver : PboResolver
    {
        #region Fields
        private byte[] _bytes;
        #endregion
    ...
    /// </summary>
    public class PboStreamResolver : PboResolver
    {
        #region Fields
    ...
    /// </summary>
    public class PboNullResolver : PboResolver
    {
        #region Methods
        /// <summary>
